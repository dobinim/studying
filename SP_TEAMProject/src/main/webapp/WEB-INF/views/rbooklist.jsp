...
<div class = "container mt-5 mx-auto">
	<h3 class = "text-center">이 달의 추천 도서</h3>
	<br/>
	<table class = "table table-hover text-center" id = "rbooklist">
		<thead id = "rbhead">
			<tr>
				<th id = "idcol">번호</th>
		...
		<tbody>
			...
			<tr>
				<td><a href = "view?bookId=${bdto.rbookId}">${bdto.rbookId}</a></td>
				<td>${bdto.rgenre}</td>			
				<td>${bdto.rbookTitle}</td>			
				<td>${bdto.rwriter}</td>			
				<td>${bdto.rpublisher}</td>			
				<td>${bdto.ryear}</td>					
			</tr>
			</c:forEach>
		</tbody>
